...
#pragma implementation "genericTestTomahawk.h"
#endif

#include <HALtestLib_win32.h>
#include <genericTestTomahawk.h>
...
genericTestTomahawk::genericTestTomahawk( void )
{
}
// }}}RME
...
genericTestTomahawk::genericTestTomahawk( const genericTestTomahawk & rtg_arg )
...
genericTestTomahawk & genericTestTomahawk::operator=( const genericTestTomahawk & rtg_arg )
{
	if( this != &rtg_arg )
...
genericTestTomahawk::genericTestTomahawk( targetConfigBase * hwPlatformConfig )
...
genericTestBase::initResult * genericTestTomahawk::init( genericTestBase::initConfig * config )
{
	// {{{USR
...
genericTestBase::testResult * genericTestTomahawk::execute( genericTestBase::testConfig * config )
{
	// {{{USR

	   targetConfigTomahawk * tomahawkTarget = new targetConfigTomahawk();

	   tomahawkTarget->init();

	   targetConfigBase::sendStringToStderr("genericTestTomahawk execute() method!\n");
...
void genericTestTomahawk::oldTest( void )
{
	// {{{USR
