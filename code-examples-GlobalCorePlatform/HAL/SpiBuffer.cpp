...
#pragma implementation "SpiBuffer.h"
#endif
...
uint32_t & SpiBuffer::operator[]( int index )
{
	// {{{USR
...
SpiBuffer::operator uint32_t *( void )
{
	// {{{USR
...
void SpiBuffer::setEndianSwap( bool value )
{
	// {{{USR
...
void SpiBuffer::endianSwap( Array * * buf )
{
	// {{{USR
...
SpiBuffer::SpiBuffer( unsigned int bufferSizeInBytes, Connection * conn, bool skipFirst, bool skipLast )
