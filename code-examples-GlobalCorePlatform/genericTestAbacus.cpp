...
#pragma implementation "genericTestAbacus.h"
#endif

#include <HALtestLib_win32.h>
#include <genericTestAbacus.h>
...
genericTestAbacus::genericTestAbacus( void )
{
}
// }}}RME
...
genericTestAbacus::genericTestAbacus( const genericTestAbacus & rtg_arg )
...
genericTestAbacus & genericTestAbacus::operator=( const genericTestAbacus & rtg_arg )
{
	if( this != &rtg_arg )
...
genericTestBase::initResult * genericTestAbacus::init( genericTestBase::initConfig * config )
{
	// {{{USR
...
genericTestBase::testResult * genericTestAbacus::execute( genericTestBase::testConfig * config )
{
	// {{{USR
...
void genericTestAbacus::oldTest( void )
{
	// {{{USR
