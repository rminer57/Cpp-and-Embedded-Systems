...
#pragma implementation "genericTestSequencer.h"
#endif

#include <HALtestLib_win32.h>
#include <genericTestSequencer.h>
...
genericTestSequencer::genericTestSequencer( void )
{
}
// }}}RME
...
genericTestSequencer::genericTestSequencer( const genericTestSequencer & rtg_arg )
...
genericTestSequencer & genericTestSequencer::operator=( const genericTestSequencer & rtg_arg )
{
	if( this != &rtg_arg )
...
genericTestBase::initResult * genericTestSequencer::init( genericTestBase::initConfig * config )
{
	// {{{USR
...
genericTestBase::testResult * genericTestSequencer::execute( genericTestBase::testConfig * config )
{
	// {{{USR
...
void genericTestSequencer::oldTest( void )
{
	// {{{USR
